...
function MenuReviewDetail() {
  const { id } = useParams({ from: "/admin/menu-review/$id" });
  ...
  return (
    <>
      <PageHeader
        title={`Menu Review · ${review.caterer}`}
        description={`${review.itemsExtracted} items extracted · ${review.confidence}% confidence`}
        actions={
          <>
