...
function CustomerDetail() {
    ...
    return (<>
      <PageHeader title={c.name} description={c.email} actions={<>
            ...
            {suspended ? (<Button onClick={() => toast.success("Customer reactivated")}><RotateCcw className="mr-2 h-4 w-4"/> Reactivate</Button>) : (<Button variant="destructive" onClick={() => toast.error("Customer suspended")}><Ban className="mr-2 h-4 w-4"/> Suspend</Button>)}
          </>}/>
            ...
            <Tabs defaultValue="bookings">
              ...
              <TabsContent value="bookings" className="mt-4">
                <Table>
                  ...
                  <TableBody>
                    {custBookings.map((b) => (<TableRow key={b.id}>
              ...
              <TabsContent value="refunds" className="mt-4">
                <Table>
                  ...
                  <TableBody>
                    {custRefunds.map((r) => (<TableRow key={r.id}>
