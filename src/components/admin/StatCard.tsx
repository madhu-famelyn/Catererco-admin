...
export function StatCard({
  ...
  return (
    <Card className="group relative overflow-hidden border-white/5 bg-card/60 backdrop-blur transition-all hover:border-primary/40 hover:shadow-[0_0_40px_-12px_var(--color-primary)]">
